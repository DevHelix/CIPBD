# project_total = total estimated cost - future costs
...
YEAR_COLS = {2013: 'year_2013', 2014: 'year_2014', 2015: 'year_2015'}
...
def parse_2012():
    pdf_path = r"C:\Users\vince\Documents\GitHub\CIPBD\Dallas\PDF\2012.pdf"
    cip_year = 2012
    records = []
        ...
        for pg in pdf.pages:
            ...
            for row in t[2:]:
                ...
                records.append({
                    ...
                    'year_2013':               clean_num(row[8]),   # FY 2012-13
                    'year_2014':               clean_num(row[9]),   # FY 2013-14
                    'year_2015':               clean_num(row[10]),  # FY 2014-15
    ...
    out = r"C:\Users\vince\Documents\GitHub\CIPBD\Scripts\Dallas\outputs\2012.csv"
    fieldnames = [
        'cip_year', 'source_page', 'department', 'project_name', 'project_type',
        'funding_source', 'address_location', 'comp_date',
        'previous_appropriations', 'spent', 'remaining',
        'year_2013', 'year_2014', 'year_2015', 'future_cost', 'project_total',
        'start_year', 'end_year',
    ]
    ...
    print(f"Done: 2012.csv — {len(merged)} projects")
